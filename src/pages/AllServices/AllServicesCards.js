...
const AllServicesCards = ({ service}) => {
	const {
		_id,
		img,
		fee,
	...
	return (
		<div className=" max-w-xl text-center bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 w-3/4 mx-auto content_div">
